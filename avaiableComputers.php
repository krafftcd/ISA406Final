...
<BODY>
    ...
    <div id="MainPicture">
        ...
        <h1 id="Header">Available Computers</h1>
    </div>
    ...
    <div id="NavBar">
        <ul>
            ...
            <li><a href="avaiableComputers.php" class="active">Available Computers</a></li>
    ...
    <br>
       ...
       ?>
        ...
        $studentEntryInfo = "Select a.NFCID, a.ComputerSerialNum, b.DeviceType, b.DeviceModel, b.GHZ, b.RAM_GB 
From NFCComputers a 
...
WHERE STUDENTID IS NULL;";
        ...
        $getstudentEntryInfo = odbc_exec($conn,$studentEntryInfo);
            echo "<table border='1'>";	
            echo "<tr><th>NFC ID</th><th>Serial Tag</th><th>Device Type</th><th>Device Model</th><th>Device GHZ</th><th>Device RAM</th></tr>";
        
				while (odbc_fetch_row($getstudentEntryInfo))
				{
					echo "<tr><td>" .odbc_result($getstudentEntryInfo, 1)."</td><td>" .odbc_result($getstudentEntryInfo, 2)."</td><td>".odbc_result($getstudentEntryInfo, 3)."</td><td>" .odbc_result($getstudentEntryInfo, 4)."</td><td>" .odbc_result($getstudentEntryInfo, 5)."</td><td>" .odbc_result($getstudentEntryInfo, 6)."</td></tr>";
